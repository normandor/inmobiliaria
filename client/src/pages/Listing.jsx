  ...
  return (
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          <div className="flex wrapifnarrow max-w-4xl mx-auto mt-7">
            <div className="fullwidth">
              ...
              <Swiper
                navigation
                className="swiper items-center mt-1 gap-2 text-slate-600 text-sm"
                style={{ flex: 'none' }}
              >
            ...
            <div className="flex-lg-2 ml-8 mt-4">
